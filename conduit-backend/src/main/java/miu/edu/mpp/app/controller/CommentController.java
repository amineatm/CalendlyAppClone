...
import miu.edu.mpp.app.dto.article.CommentRequestWrapper;
...
public class CommentController {
    ...
    public ResponseEntity<Map<String, List<CommentResponse>>> addComment(@PathVariable String slug, @RequestBody @Valid CommentRequestWrapper<CommentRequest> request) {
